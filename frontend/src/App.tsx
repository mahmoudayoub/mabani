          ...
          Header() {
            return (
              <div className="text-center mb-6 pt-4">
                <img src="/logo-almabani.png" alt="Almabani Logo" className="mx-auto h-16 w-auto mb-4" />
                <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">
                  Almabani AI Platform – AlmaAIP
                </h1>
          ...
          Header() {
            return (
              <div className="text-center mb-6 pt-4">
                ...
                <p className="text-gray-600 text-sm">
                  Join Almabani AI Platform and start managing your tasks
                </p>
              </div>
            );
          },
