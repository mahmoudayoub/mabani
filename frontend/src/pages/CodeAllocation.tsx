...
// Modal Component extracted for reuse
const SummaryModal = ({
    showSummary,
    setShowSummary,
    viewContent,
    ...
    if (!showSummary && !viewContent && !viewSummaryData && !resultData) return null;

    // We explicitly require showSummary or viewContent to be present to show the modal
    if (!showSummary && !viewContent) return null;
                                        ...
                                        {viewSummaryData.filters && viewSummaryData.filters.length > 0 && (
                                            <div className="bg-gray-50 rounded-lg p-4">
                                                ...
                                                <div className="space-y-1">
                                                    {viewSummaryData.filters.map((filter: string, i: number) => (
