                ...
                <div className="lg:col-span-1">
                    <div className="bg-white rounded-lg shadow p-6">
                        ...
                        <div className="mb-6">
                            ...
                            <div
                                className={`mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-dashed rounded-md transition-colors ${isDragOver ? 'border-primary-500 bg-primary-50' : 'border-gray-300'}`}
